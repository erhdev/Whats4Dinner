        ...
        db.Restaurants.bulkCreate([
            ...
            request.get("/").end(function (err, res) {
                ...
                expect(responseBody[0])
                    .to.be.an("object")
                    .that.includes({ text: "First Restaurant", description: "First Cateogry" });

                expect(responseBody[1])
                    .to.be.an("object")
                    .that.includes({ text: "Second Restaurant", description: "Second Cateogry" });
